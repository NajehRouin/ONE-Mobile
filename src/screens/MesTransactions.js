...
const MesTransactions = ({navigation})  => {
  ...
  const onRefresh = useCallback(() => {
   ...
   const[nbtransaction,setTransaction]=useState();
      ...
      const fetchTransaction = async () => {
        ...
        try {
         ...
         // console.log('fetech',datafetch)
          ...
          setTransaction(CurrentU.nbTransaction)
...
<View style={{marginTop:10,alignContent:'center',justifyContent:'center',alignItems:'center'}}>
    <Text style={{fontSize:20,alignItems:'center',fontWeight:'bold',color:'#032D56'}}>{nbtransaction}</Text>
</View>
